            ...
            <div className="min-h-screen flex items-center justify-center bg-background px-4">
                <div className="w-full max-w-sm space-y-8">
                    ...
                    <div className="rounded-2xl border border-border bg-card p-7 space-y-5">
                        <div>
                            <h2 className="font-display text-xl font-bold text-foreground">Nueva contraseña</h2>
                        ...
                        <form onSubmit={submit} className="space-y-4">
                            <div className="space-y-1.5">
                                ...
                                <input
                                    ...
                                    autoComplete="email"
                                    readOnly
                                    className="w-full rounded-xl border border-input bg-muted px-4 py-2.5 text-sm text-muted-foreground focus:outline-none cursor-default"
                                />
                            </div>

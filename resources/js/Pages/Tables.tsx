                    ...
                    {tables.map(t => {
                        ...
                        return (
                            ...
                            >
                                ...
                                {/* ── Info de la mesa ── */}
                                <div className="text-sm text-muted-foreground mb-1">Capacidad: {t.capacity ? `${t.capacity} pers.` : 'No especificada'}</div>
                    ...
                    <div className="w-full max-w-sm rounded-2xl border border-border bg-card p-6 shadow-xl">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    <label className="block text-sm font-medium mb-1.5">Capacidad <span className="text-muted-foreground font-normal text-xs ml-1">(Opcional)</span></label>
                                    <input type="number" min={1}
                                        className="w-full rounded-xl border border-input bg-input px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary/50"
